    ...
    return function patch (oldVnode, vnode, hydrating, removeOnly) {
      ...
      if (isUndef(oldVnode)) {
        ...
        if (!isRealElement && sameVnode(oldVnode, vnode)) {
          ...
          var oldElm = oldVnode.elm; // ! 被转换的 DOM 对象
          var parentElm = nodeOps.parentNode(oldElm); // ! 初始化时父级DOM元素为body
